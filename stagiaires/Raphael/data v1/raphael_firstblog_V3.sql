...
-- -----------------------------------------------------
-- Table `raphael_firstblog`.`category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `raphael_firstblog`.`category` ;

CREATE TABLE IF NOT EXISTS `raphael_firstblog`.`category` (
...
-- -----------------------------------------------------
-- Table `raphael_firstblog`.`article_has_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `raphael_firstblog`.`article_has_category` ;

CREATE TABLE IF NOT EXISTS `raphael_firstblog`.`article_has_category` (
  `article_id` INT UNSIGNED NOT NULL,
  `category_id` SMALLINT UNSIGNED NOT NULL,
  PRIMARY KEY (`article_id`, `category_id`),
  INDEX `fk_article_has_category_category1_idx` (`category_id` ASC) VISIBLE,
  INDEX `fk_article_has_category_article1_idx` (`article_id` ASC) VISIBLE,
  CONSTRAINT `fk_article_has_category_article1`
    FOREIGN KEY (`article_id`)
    REFERENCES `raphael_firstblog`.`article` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_article_has_category_category1`
    FOREIGN KEY (`category_id`)
    REFERENCES `raphael_firstblog`.`category` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
