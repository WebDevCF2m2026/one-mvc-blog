...
-- -----------------------------------------------------
-- Schema laetitia_first_blog
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `laetitia_first_blog` ;

-- -----------------------------------------------------
-- Schema laetitia_first_blog
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `laetitia_first_blog` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `laetitia_first_blog` ;

-- -----------------------------------------------------
-- Table `laetitia_first_blog`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `laetitia_first_blog`.`user` ;

CREATE TABLE IF NOT EXISTS `laetitia_first_blog`.`user` (
